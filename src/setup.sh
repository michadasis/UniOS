...
# Signed-by parameter explicitly mapping your custom repository to your trusted GPG key ring
cat > /etc/apt/sources.list.d/unios.list << 'EOF'
deb [signed-by=/etc/apt/trusted.gpg.d/unios-ppa.gpg] https://ppa.launchpadcontent.net/unios-team/unios-core-stable/ubuntu noble main
EOF
